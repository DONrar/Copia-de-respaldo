...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonSearchbar, IonSegment, IonSegmentButton, IonLabel, IonList, IonItem, IonIcon, IonBadge, IonButton, IonSelect, IonSelectOption, IonDatetime, IonModal, IonButtons, IonBackButton, IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonMenuButton } from '@ionic/angular/standalone';
...
import {
  ...
  peopleOutline, closeCircle, searchOutline, callOutline,
  timeOutline, calendarOutline, cashOutline, trashOutline
} from 'ionicons/icons';
...
export class BusquedaPage implements OnInit {
  ...
  constructor(
    ...
    addIcons({
      cartOutline, peopleOutline, filterOutline, codeOutline,
      documentTextOutline, gridOutline, logoWhatsapp, closeCircle,
      searchOutline, callOutline, timeOutline, calendarOutline,
  ...
  limpiarBusqueda() {
    ...
    // Limpiar el searchbar visualmente
