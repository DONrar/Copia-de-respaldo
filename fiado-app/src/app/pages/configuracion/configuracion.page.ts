...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonList, IonItem, IonLabel, IonButton, IonIcon, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonButtons, IonBackButton, IonNote, AlertController, IonToggle, IonMenuButton } from '@ionic/angular/standalone';
import { Router } from '@angular/router';
import { addIcons } from 'ionicons';
import {
  downloadOutline, cloudUploadOutline, trashOutline,
  informationCircleOutline, shieldCheckmarkOutline,
  documentTextOutline, settingsOutline, warning, statsChartOutline, peopleOutline, cartOutline, saveOutline, helpCircleOutline, warningOutline, cubeOutline, serverOutline, alertCircleOutline } from 'ionicons/icons';
...
export class ConfiguracionPage implements OnInit {
  ...
  constructor(
    ...
    addIcons({settingsOutline,statsChartOutline,peopleOutline,cartOutline,saveOutline,shieldCheckmarkOutline,downloadOutline,cloudUploadOutline,informationCircleOutline,serverOutline,warningOutline,alertCircleOutline,helpCircleOutline,documentTextOutline,trashOutline,warning,cubeOutline});
  }

 async ngOnInit() {
    await this.cargarEstadisticas();
    await this.cargarEstadisticasAlmacenamiento(); // Agregar
  }
  ...
  // Agregar después de estadisticas
  almacenamiento = {
  totalSizeMB: '0',
  porcentajeUsado: 0, // ← Cambiar de '0' a 0 (número)
  espacioDisponibleMB: '0',
  limiteMB: '5'
};


  // Agregar método
  async cargarEstadisticasAlmacenamiento() {
    this.almacenamiento = await this.storageService.obtenerEstadisticasAlmacenamiento();
  }
}
