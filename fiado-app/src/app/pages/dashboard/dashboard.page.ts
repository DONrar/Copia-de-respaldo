...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonButton, IonIcon, IonList, IonItem, IonLabel, IonBadge, IonGrid, IonRow, IonCol, IonRefresher, IonRefresherContent, IonFab, IonFabButton, IonButtons, IonAvatar, IonRouterLinkWithHref, IonMenuButton } from '@ionic/angular/standalone';
...
import {
  ...
  add, statsChart, personAdd, person, home, list, receipt, settingsOutline, chevronForward } from 'ionicons/icons';
...
@Component({
  ...
  imports: [IonAvatar, IonButtons, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, CommonModule,
    ...
    IonRefresherContent, IonFab, IonFabButton, RouterLinkActive, IonRouterLinkWithHref, RouterLink, IonMenuButton]
})
export class DashboardPage implements OnInit {
  ...
  constructor(
    ...
    addIcons({statsChart,search,settingsOutline,cash,wallet,trendingUp,people,chevronForward,timeOutline,checkmarkCircle,cart,person,personAdd,add,receipt,list,time,home,refreshOutline});
  }
