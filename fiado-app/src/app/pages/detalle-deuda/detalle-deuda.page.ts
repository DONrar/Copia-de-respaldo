...
import { IonContent, IonHeader, IonTitle, ActionSheetController,IonToolbar, IonButton, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonList, IonItem, IonLabel, IonBackButton, IonButtons, IonIcon, IonBadge, IonInput, IonNote, AlertController, IonMenuButton } from '@ionic/angular/standalone';
import { ActivatedRoute, Router } from '@angular/router';
import { addIcons } from 'ionicons';
import {
  calendar, cart, cash, checkmarkCircle,
  documentText, person, walletOutline, shareSocial,logoWhatsapp } from 'ionicons/icons';
...
export class DetalleDeudaPage implements OnInit {
  ...
  addIcons({
    calendar, cart, cash, checkmarkCircle,
    documentText, person, walletOutline, shareSocial, logoWhatsapp // Agregar shareSocial
  });
}
...
async compartirWhatsApp() {
  ...
  editarDeuda() {
    this.router.navigate(['/editar-deuda', this.deudaId]);
  }

  async confirmarEliminarDeuda() {
  ...
  async eliminarDeuda() {
    try {
      await this.deudasService.eliminarDeuda(this.deudaId);
      // Después de eliminar, volver al detalle del cliente
      if (this.deuda) {
