...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonButton, IonInput, IonItem, IonLabel, IonBackButton, IonButtons, IonTextarea, AlertController, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonIcon, IonMenuButton } from '@ionic/angular/standalone';
import { ActivatedRoute, Router } from '@angular/router';
import { addIcons } from 'ionicons';
import {
  saveOutline, trashOutline, personOutline,
  cardOutline, callOutline, mailOutline,
  locationOutline, documentTextOutline, personCircleOutline,
  calendarOutline, cashOutline, closeOutline, warningOutline,
  alertCircleOutline
} from 'ionicons/icons';
...
export class EditarClientePage implements OnInit {
  ...
  constructor(
    ...
    addIcons({
      saveOutline, personCircleOutline, callOutline, documentTextOutline,
      calendarOutline, cashOutline, closeOutline, warningOutline,
      alertCircleOutline, trashOutline, personOutline, cardOutline,
      mailOutline, locationOutline
    });
  }
