...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonButton, IonInput, IonItem, IonLabel, IonBackButton, IonButtons, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonIcon, IonTextarea, IonList, IonItemSliding, IonItemOptions, IonItemOption, IonMenuButton } from '@ionic/angular/standalone';
import { ActivatedRoute, Router } from '@angular/router';
import { addIcons } from 'ionicons';
import { add, trash, cart, addCircleOutline, cartOutline, closeCircle, documentTextOutline, saveOutline, closeOutline, addCircle } from 'ionicons/icons';
...
@Component({
  ...
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, CommonModule,
    ...
    IonList, IonItemSliding, IonItemOptions, IonItemOption, IonMenuButton]
})
export class NuevaDeudaPage implements OnInit {
  ...
  constructor(
    ...
    addIcons({addCircleOutline,addCircle,cartOutline,closeCircle,documentTextOutline,saveOutline,closeOutline,add,trash,cart});
  }
